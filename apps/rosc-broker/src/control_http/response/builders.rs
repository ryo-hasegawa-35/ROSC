...
use crate::{
    ...
    ProxyOperatorReadiness, ProxyOperatorReport, ProxyOperatorRouteTrace, ProxyOperatorSignalsView,
...
use super::payloads::{
    ...
    OperatorDestinationTraceResponse, OperatorDiagnosticsResponse, OperatorFocusResponse,
