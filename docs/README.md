...
This directory is organized into two document families:

- [Concepts / Planning (English)](./concepts/en/README.md)
- [Concepts / Planning (Japanese)](./concepts/ja/README.md)
- [Design Specs (English)](./design/en/README.md)
- [Design Specs (Japanese)](./design/ja/README.md)
...
- `docs/concepts/`
  - vision, roadmap, planning, priorities, and phased delivery notes
- `docs/design/`
  - technical specifications, behavior models, configuration grammar, and
    operational design
- `docs/references/`
  - local copies of primary source material

## Working Rule

All new project documents should have:

- an English version
- a Japanese version
- placement in either `concepts` or `design`, never mixed casually

## Suggested Starting Points

- For project vision and phase planning:
  - [Concepts / Planning (Japanese)](./concepts/ja/README.md)
